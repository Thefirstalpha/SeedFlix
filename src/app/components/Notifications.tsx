        ...
        <div>
          ...
          {unreadCount > 0 && (
            <p className="text-sm text-white/70 mt-2">
              {t(
                unreadCount > 1 ? 'notificationsPage.unread_many' : 'notificationsPage.unread_one',
                { count: unreadCount },
              )}
            </p>
          )}
        ...
        <div className="space-y-3">
          {notifications.map((notif) => (
            <Card
              ...
              className={`p-4 border-l-4 border-white/10 transition-all ${getTypeColor(
                notif.type,
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-start">
                <div className="min-w-0 flex-1">
                  <div className="mb-1 flex flex-wrap items-center gap-2">
                    <h3 className="font-semibold text-white break-words">{notif.title}</h3>
