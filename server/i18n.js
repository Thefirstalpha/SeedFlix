const messages = {
  fr: {
    ...
    tmdb: {
      apiKeyNotConfigured:
        "La cle API TMDB n'est pas configuree. Configurez-la dans les parametres.",
...
function getUserLanguage(user) {
  const language = String(user?.settings?.placeholders?.preferences?.language || '').toLowerCase();
