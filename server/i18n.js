const messages = {
  fr: {
    ...
    notifications: {
      ...
      trackerMovieAvailable: "Film disponible sur tracker",
      trackerSeriesAvailable: "Serie disponible sur tracker",
      trackerSeasonAvailable: "Saison disponible sur tracker",
      trackerEpisodeAvailable: "Episode disponible sur tracker",
      trackerReleaseBatchLabelOne: "{{first}} (+{{extra}} autre)",
      trackerReleaseBatchLabelMany: "{{first}} (+{{extra}} autres)",
      trackerReleaseMessage: "{{title}}: {{count}} torrent(s) trouve(s).",
    },
    transmission: {
  ...
  en: {
    ...
    notifications: {
      ...
      trackerMovieAvailable: "Movie available on tracker",
      trackerSeriesAvailable: "Series available on tracker",
      trackerSeasonAvailable: "Season available on tracker",
      trackerEpisodeAvailable: "Episode available on tracker",
      trackerReleaseBatchLabelOne: "{{first}} (+{{extra}} more)",
      trackerReleaseBatchLabelMany: "{{first}} (+{{extra}} more)",
      trackerReleaseMessage: "{{title}}: {{count}} torrent(s) found.",
    },
    transmission: {
