...
const messagesList: Record<string, Translation> = {
  fr: {
    tmdb: {
      apiKeyNotSet:
        "La clé API de TMDB n'est pas configurée. Veuillez la définir dans les paramètres globaux.",
    ...
    settings: {
      transmission: {
        authFailed:
          "Échec de l'authentification avec Transmission. Veuillez vérifier vos paramètres.",
